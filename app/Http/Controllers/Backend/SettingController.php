...
class SettingController extends Controller
{
    ...
    public function UpdateSEO(Request $request,$id)
    {
		  ...
		  $data['horizontal1']=$request->horizontal1;
		  $data['horizontal2']=$request->horizontal2;
		  $data['horizontal3']=$request->horizontal3;
		  $data['horizontal4']=$request->horizontal4;
	      $data['horizontal5']=$request->horizontal5;
	      $data['horizontalbig1']=$request->horizontalbig1;
		  $data['horizontalbig2']=$request->horizontalbig2;
		  $data['horizontalbig3']=$request->horizontalbig3;
		  $data['horizontalbig4']=$request->horizontalbig4;
...
//important website
    ...
    public function UpdateWebsite(Request $request,$id)
    {
		   ...
		   $data['chiefadvisor']=$request->chiefadvisor;
           $data['publisher']=$request->publisher;
           $data['managingeditor']=$request->managingeditor;
		   $data['messageeditor']=$request->messageeditor;
		   ...
		   $image=$request->lazybaner;
           if ($image) {
                $image_one= uniqid().'.'.$image->getClientOriginalExtension();    //123123.jpg
                Image::make($image)->resize(700,390)->save('public/ads/'.$image_one);    //   public/postimages/123123.jpg
                $data['lazybaner']='public/ads/'.$image_one;   //   public/postimages/123123.jpg
                 DB::table('settings')->where('id',$id) ->update($data);
                 $notification=array(
                     'messege'=>'Successfully Settings Updated ',
                     'alert-type'=>'success'
