              ...
              <table id="example1" class="table table-bordered table-striped">
               ...
               @foreach($ads as $row)
                <tr>
                  <td>
                  	@if($row->type==2)
                  		<img src="{{ asset($row->ads) }}" style="height: 100px; width: 100px;">
					@else
                  		<img src="{{ asset($row->ads) }}" style="height: 100px; width: 100px;">
                  	@endif
                  	</td>
            ...
            <div class="modal-body">
               <form action="{{ route('store.ads') }}" method="Post" enctype="multipart/form-data">
				 ...
				 <div class="form-group">
                   ...
                   <input type="text" class="form-control @error('desigination') is-invalid @enderror" id="english" aria-describedby="emailHelp" name="desigination" required="">
                     @error('desigination')
		              <span class="invalid-feedback" role="alert">
		                  <strong>{{ $message }}</strong>
		              </span>
                 ...
                 <div class="form-group">
                   <label for="exampleInputPassword1">Staff Images</label>
