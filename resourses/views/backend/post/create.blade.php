                ...
                <div class="row">
                 ...
                 <div class="row">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" value="1"  name="views">
                  </div>
               </div>
			                    <div class="row">
                  <div class="form-group col-md-12">
                    <label for="exampleInputEmail1">E-Paper Post Link</label>
                    <input type="text" class="form-control" id="exampleInputEmail1"  name="printviewlink">
                  </div>
               </div>
			     ...
			     <div class="row">
                  <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1"  name="details_en">
                  </div>
               </div>
                    <div class="form-group  col-md-12">
                    <label for="exampleInputPassword1">Details</label>
                     <textarea class="textarea" placeholder="Place some text here" name="details_bn" 
                          style="width: 100%; height: 300px;font-family: "SolaimanLipiNormal", Helvetica, Arial, sans-serif; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                  </div>
                  <hr>
