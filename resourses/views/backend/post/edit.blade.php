            ...
            <div class="card card-primary">
              ...
              <form role="form"  action="{{ route('update.post',$post->id) }}" method="post"  enctype="multipart/form-data"> 
                ...
                <div class="row">
                 ...
                 <div class="row">
                  <div class="form-group col-md-12">
                    <label for="exampleInputEmail1">Images Caption</label>
                    <input type="text" class="form-control" id="exampleInputEmail1"  name="tags_bn" value="{{ $post->tags_bn }}">
                  </div>
               </div>
			                    <div class="row">
                  <div class="form-group col-md-12">
                    <label for="exampleInputEmail1">News Views Counter Start</label>
                    <input type="text" class="form-control" id="exampleInputEmail1"  name="views" value="{{ $post->views }}">
                  </div>
               </div>
			                    <div class="row">
                  <div class="form-group col-md-12">
                    <label for="exampleInputEmail1">E-Paper Post Link</label>
                    <input type="text" class="form-control" id="exampleInputEmail1"  name="printviewlink" value="{{ $post->printviewlink }}">
                  </div>
               </div>
			   			                    <div class="row">
                  <div class="form-group col-md-12">
                    <label for="exampleInputEmail1">Short Details (Maximum 60 Word)</label>
                    <input type="text" class="form-control" id="exampleInputEmail1"  name="details_en" value="{{ $post->details_en }}">
                  </div>
               </div>
                    <div class="form-group  col-md-12">
                    <label for="exampleInputPassword1">Details</label>
                     <textarea class="textarea" placeholder="Place some text here" name="details_bn" 
                          style="width: 100%; height: 300px;font-family: "SolaimanLipiNormal", Helvetica, Arial, sans-serif; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">
                          	{{ $post->details_bn }}
                          </textarea>
                  </div>
                  <hr>
