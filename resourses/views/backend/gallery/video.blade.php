              ...
              <table id="example1" class="table table-bordered table-striped">
               ...
               @foreach($video as $row)
                <tr>
                  ...
                  <td>
                  	@if($row->type == 1)
                  	      <span class="badge badge-success">Video News</span>
                  	      @else
                  	      <span class="badge badge-info">Entertainemnt</span>
                  	      @endif
                  </td>
                  <td>
            ...
            <div class="modal-body">
               <form action="{{ route('store.videos') }}" method="Post" >
                 ...
                 <select class="form-control" name="type" required>
                 	  <option value="1">Video News</option>
                 	  <option value="0">Entertainemnt</option>
                 </select>
